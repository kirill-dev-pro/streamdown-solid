...
describe('Markdown Components', () => {
  describe('List Components', () => {
    ...
    it('should render list item with correct classes', () => {
      ...
      const { container } = render(() => <LI node={null as any}>List item content</LI>)
  ...
  describe('Text Formatting Components', () => {
    it('should render strong with correct classes', () => {
      ...
      const { container } = render(() => <Strong node={null as any}>Bold text</Strong>)
    ...
    it('should render blockquote with correct classes', () => {
      ...
      const { container } = render(() => <Blockquote node={null as any}>Quote text</Blockquote>)
  ...
  describe('Code Components', () => {
    ...
    it('should render pre with code block', () => {
      ...
      const codeElement = <code>const x = 1;</code>
      const { container } = render(() => <Pre>{codeElement}</Pre>)
    ...
    it('should extract code from children in pre component', () => {
      const Pre = components.pre!
      const { container } = render(() => <Pre>plain text code</Pre>)
